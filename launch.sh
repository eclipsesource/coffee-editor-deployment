...
echo Echo environment 1.NAMESPACE 2.IMAGE_NAME 3.IMAGE_VERSION 4.IMAGE_REGISTRY 5.MAX_CONCURRENT_USERS 6.MIN_AVAILABLE_SERVICES 7.JOB_CLEANUP_MINUTES 8.JOB_TTL_SECONDS 9.CLEANUP_HOURS 10.DEBUGGING 11.INGRESS_LIMIT 12.EGRESS_LIMIT 13.PARALLEL_SPAWN 14.HOST 15.PREFIX
echo $NAMESPACE
echo $IMAGE_NAME
echo $IMAGE_VERSION
echo $IMAGE_REGISTRY
